function [distance_total, distance_center, time_center, speed_average, speed_avg_center,entries] = openfield_circle_centerinput(x,y,duration, center_ratio, x_max, x_min, y_max, y_min)
...
for i = 1:len
    ...
    center_dist = sqrt(((x_valid(i) - x_center)^2) + ((y_valid(i) - y_center)^2));
   
    if center_dist <= (100/(2*center_ratio))
